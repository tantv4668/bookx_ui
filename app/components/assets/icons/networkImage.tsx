...
import { Size, getSize } from '../../utils/getSize';
import { WalletIcon } from './wallet';

export type NetworkImageType = 'symbol' | 'chain' | 'token' | 'placeholder' | 'path' | 'unknown' | 'wallet';
...
export const NetworkImage: FC<NetworkImageProps> = memo((props) => {
	...
	const [isPlaceholder, setIsPlacholder] = useState(() => props.type === 'placeholder');
	...
	useEffect(() => {
		if (typeof props.type === 'undefined' && typeof props.symbol === 'undefined') {
