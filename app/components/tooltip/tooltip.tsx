...
const Tooltip = ({ className, open, defaultOpen, onOpenChange, children, content, sideOffset = 4, ...props }: any) => {
	return (
		<TooltipPrimitive.Root open={open} defaultOpen={defaultOpen} onOpenChange={onOpenChange}>
			...
			>
				{content}
				<TooltipPrimitive.Arrow width={11} height={5} className="orderly-fill-base-400" />
			</TooltipPrimitive.Content>
