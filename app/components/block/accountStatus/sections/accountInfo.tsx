'use client';
import Button, { IconButton } from '../../../globals/button';
...
import { CopyIcon } from '@/app/components/assets/icons/copy';
import { ArrowRightIcon } from '@/app/components/assets/icons/arrowRight';
...
const ReferralInfo = () => {
	...
	const { data: volumeStatistics } = usePrivateQuery<any>('/v1/volume/user/stats', {
		revalidateOnFocus: true,
	});
	...
	return (
		<div className="orderly-bg-base-600 orderly-rounded-lg orderly-p-3 orderly-mb-3">
			<div className="orderly-flex orderly-items-center orderly-cursor-pointer" onClick={clickReferral}>
				...
				<ArrowRightIcon size={14} className="orderly-fill-primary" />
			</div>
