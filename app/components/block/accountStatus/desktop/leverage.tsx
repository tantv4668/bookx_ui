...
import { useMarginRatio, useAccountInfo, useLeverage } from '@orderly.network/hooks';
...
const LeverageAndMarginRatio = (props: LeverageAndMarginRatioProps) => {
	...
	return (
		<div id="orderly-account-leverage" className={'orderly-flex orderly-justify-between orderly-text-xs'} {...rest}>
			<div className={'orderly-flex orderly-flex-col orderly-tabular-nums orderly-items-start'}>
				<Tooltip
					// @ts-ignore
					content={
						<div>
				...
				>
					<div
						...
						className={'orderly-text-base-contrast-54 orderly-text-3xs orderly-cursor-pointer'}
					>
						Margin ratio
					</div>
				</Tooltip>
			...
			<div id="orderly-desktop-max-leverage" className={'orderly-flex orderly-flex-col orderly-items-end'}>
				...
				<div
					...
					className={'orderly-flex orderly-items-center orderly-gap-1 orderly-text-2xs'}
				>
					{isConnected ? <Numeral surfix={'x'}>{currentLeverage}</Numeral> : '-'}
