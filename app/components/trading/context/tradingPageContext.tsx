...
export const TradingPageContext = React.createContext<TradingPageContextValue>({} as TradingPageContextValue);
...
export const TradingPageProvider: React.FC<PropsWithChildren<TradingPageProviderProps>> = ({
	children,
	onSymbolChange,
	symbol,
	disableFeatures = [],
	...
	useExecutionReport();
	return (
		<TradingPageContext.Provider value={{ onSymbolChange, symbol, disableFeatures, overrides }}>
			{children}
