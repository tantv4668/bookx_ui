...
export const WalletConnectSheet = create<WalletConnectProps>((props: any) => {
  // const { visible, hide, resolve, reject, onOpenChange } = useModal();
  // // get account status and handle sign in and enable trading
  // const { account, createOrderlyKey, createAccount } = useAccount();
  // // @ts-ignore
  ...
  return (
    <Sheet open={visible} onOpenChange={onOpenChange}>
      <SheetContent onOpenAutoFocus={(e: any) => e.preventDefault()}>
...
export const WalletConnectDialog = create<WalletConnectProps>((props: any) => {
  const {
    visible,
    hide,
    resolve,
