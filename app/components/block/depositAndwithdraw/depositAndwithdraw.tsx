...
export const DepositAndWithdrawWithSheet = create<DepositAndWithdrawProps>((props: any) => {
...
export const DepositAndWithdrawWithDialog = create<DepositAndWithdrawProps>((props: any) => {
	const { visible, hide, resolve, reject, onOpenChange } = useModal();
