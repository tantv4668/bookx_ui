...
function setModalStates(id: string, states: Record<string, unknown>): ModalAction {
	return {
	...
	return (
		<>
			{components.map((component) => {
				return <component.comp key={component.id} id={component.id} {...component.props} />;
			})}
		</>
	);
};
...
function show<T extends any, C extends any>(modal: React.FC<C>, args?: ModalArgs<React.FC<C>>): Promise<T>;
function show<T extends any>(modal: string, args?: Record<string, unknown>): Promise<T>;
function show<T extends any, P extends any>(modal: string, args?: P): Promise<T>;
function show<T extends any, P extends any>(modal: React.FC<any> | string, args?: any): Promise<unknown> {
