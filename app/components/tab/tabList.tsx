'use client';
import { FC, ReactNode, useCallback, useContext, useEffect, MouseEvent, useMemo, useRef, useState } from 'react';
					...
					{props.tabs.map((item, index) => {
						return (
							<Tab
								...
								active={!!item.value && !!props.value && item.value === props.value && tabContext.contentVisible}
								onClick={onItemClick}
							/>
						);
					})}
