...
export const Assets: FC<AssetsProps> = (props) => {
	...
	return (
		...
		>
			<div className={'orderly-py-3 orderly-flex orderly-justify-between orderly-items-center orderly-tabular-nums'}>
				<div className={'orderly-flex-1'}>
					<div className={'orderly-text-3xs orderly-text-base-contrast-54'}>Total balance</div>
					<div>
						<Numeral
							surfix={<span className={'orderly-text-base-contrast-36 orderly-font-medium'}>USDC</span>}
