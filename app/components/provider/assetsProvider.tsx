...
import { DepositAndWithdrawWithDialog, DepositAndWithdrawWithSheet } from '../block/depositAndwithdraw';
...
export const AssetsContext = createContext<AssetsContextState>({} as AssetsContextState);

export const AssetsProvider: FC<any> = (props) => {
	...
	const onSettle = useCallback(async () => {
		return account
			...
			.catch((e) => {
				if (e.code == -1104) {
					toast.error('Settlement is only allowed once every 10 minutes. Please try again later.');
	...
	const [visible, setVisible] = useLocalStorage<boolean>('orderly_assets_visible', true);
