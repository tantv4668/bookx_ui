'use client';
import { InfoIcon } from '@/app/components/assets/icons/info';
	...
	return (
		<Tooltip>
			<TooltipTrigger asChild>
				<div className="orderly-text-base-contrast-54 orderly-text-xs desktop:orderly-text-base orderly-cursor-pointer">
					<span>Remember me</span>
					<InfoIcon className="orderly-inline-block orderly-ml-2" size={14} />
				</div>
			</TooltipTrigger>
			...
			>
				...
				<TooltipArrow className="orderly-fill-base-400"></TooltipArrow>
			</TooltipContent>
		</Tooltip>
	);
};
