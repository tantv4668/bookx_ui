...
const iconButtonVariants = cva(['orderly-rounded-full orderly-flex orderly-items-center orderly-justify-center'], {
	variants: {
		variant: {
			outlined: '',
...
const IconButton: FC<PropsWithChildren<ButtonProps>> = ({ className, size, color, variant, disabled, ...props }) => {
	return (
		<button
			className={cn(
				iconButtonVariants({
